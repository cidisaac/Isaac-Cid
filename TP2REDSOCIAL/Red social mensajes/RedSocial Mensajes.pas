...
//Pos-Cond: Todos los campos del vector de ultimos pensamientos quedaron seteados con un ID invalido que no pertenece a pensamietos.dat
...
//Autor: Gaston Snaider
//Comprueba si un mensaje esta en blanco.
...
//          IDUsuarioActual = ID del usuario logueado.
//          Volver = Booleana que determina a que pantalla volver.
